...
# Encoders - `jsonable_encoder`[¶](https://fastapi.tiangolo.com/pt/reference/encoders/#encoders-jsonable_encoder "Permanent link")

## fastapi.encoders.jsonable\_encoder [¶](https://fastapi.tiangolo.com/pt/reference/encoders/#fastapi.encoders.jsonable_encoder "Permanent link")
...
**TYPE:** `[dict](https://fastapi.tiangolo.com/pt/python-types/#dict "Dict")[Any, Callable[[Any], Any]] | None` **DEFAULT:** `None`
