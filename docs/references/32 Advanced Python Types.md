# Advanced Python Types - FastAPI

# Advanced Python Types[¶](https://fastapi.tiangolo.com/advanced/advanced-python-types/#advanced-python-types "Permanent link")

Here are some additional ideas that might be useful when working with Python types.

## Using `Union` or `Optional`[¶](https://fastapi.tiangolo.com/advanced/advanced-python-types/#using-union-or-optional "Permanent link")
...
`from typing import Union def say_hi(name: Union[str, None]):         print(f"Hi {name}!")`
...
`def say_hi(name: str | None):     print(f"Hey {name}!")`
