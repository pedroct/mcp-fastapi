...
# Request Parameters[¶](https://fastapi.tiangolo.com/pt/reference/parameters/#request-parameters "Permanent link")
...
## fastapi.Query [¶](https://fastapi.tiangolo.com/pt/reference/parameters/#fastapi.Query "Permanent link")
...
Read more about it in the [FastAPI docs about Query parameters](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#alternative-old-query-as-the-default-value)
...
Read more about it in the [FastAPI docs about Query parameters](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#alias-parameters)
...
Read more about it in the [FastAPI docs about Query parameters](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#declare-more-metadata)
...
Read more about it in the [FastAPI docs about Path parameters numeric validations](https://fastapi.tiangolo.com/tutorial/path-params-numeric-validations/#number-validations-greater-than-and-less-than-or-equal)
...
Read more about it in the [FastAPI docs about Query parameters](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/)
...
Read more about it in the \[FastAPI docs about Query parameters\](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#add-regular-expressions
...
Read more about it in the [FastAPI docs for Declare Request Example Data](https://fastapi.tiangolo.com/tutorial/schema-extra-example/)

**TYPE:** `[list](https://fastapi.tiangolo.com/pt/python-types/#list "List")[Any] | None` **DEFAULT:** `None`

`example`

Deprecated in OpenAPI 3.1.0 that now uses JSON Schema 2020-12, although still supported. Use examples instead.

**TYPE:** `Any | None` **DEFAULT:** `_Unset`
...
Read more about it in the [FastAPI docs for Declare Request Example Data](https://fastapi.tiangolo.com/tutorial/schema-extra-example/#using-the-openapi_examples-parameter).

**TYPE:** `[dict](https://fastapi.tiangolo.com/pt/python-types/#dict "Dict")[str, [Example](https://fastapi.tiangolo.com/pt/reference/openapi/models/#fastapi.openapi.models.Example "<code class=\"doc-symbol doc-symbol-heading doc-symbol-class\"></code>            <span class=\"doc doc-object-name doc-class-name\">Example</span>")] | None` **DEFAULT:** `None`
...
Read more about it in the [FastAPI docs about Query parameters](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#deprecating-parameters)
...
Read more about it in the \[FastAPI docs about Query parameters\](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#exclude-parameters-from-openapi
...
`from typing import Annotated from fastapi import FastAPI, Path app = FastAPI() @app.get("/items/{item_id}") async def read_items(     item_id: Annotated[int, Path(title="The ID of the item to get")], ):     return {"item_id": item_id}`
...
Read more about it in the [FastAPI docs for Path Parameters and Numeric Validations](https://fastapi.tiangolo.com/tutorial/path-params-numeric-validations/#declare-metadata)
...
Read more about it in the [FastAPI docs for Body - Multiple Parameters](https://fastapi.tiangolo.com/tutorial/body-multiple-params/#embed-a-single-body-parameter).
...
## fastapi.Header [¶](https://fastapi.tiangolo.com/pt/reference/parameters/#fastapi.Header "Permanent link")
...
Read more about it in the [FastAPI docs for Header Parameters](https://fastapi.tiangolo.com/tutorial/header-params/#automatic-conversion)
...
## fastapi.File [¶](https://fastapi.tiangolo.com/pt/reference/parameters/#fastapi.File "Permanent link")
