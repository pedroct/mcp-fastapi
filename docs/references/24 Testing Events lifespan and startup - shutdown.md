...
# Testing Events: lifespan and startup - shutdown[¶](https://fastapi.tiangolo.com/advanced/testing-events/#testing-events-lifespan-and-startup-shutdown "Permanent link")
