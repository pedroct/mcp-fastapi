...
# Strict Content-Type Checking[¶](https://fastapi.tiangolo.com/advanced/strict-content-type/#strict-content-type-checking "Permanent link")
...
## CSRF Risk[¶](https://fastapi.tiangolo.com/advanced/strict-content-type/#csrf-risk "Permanent link")
...
## Example Attack[¶](https://fastapi.tiangolo.com/advanced/strict-content-type/#example-attack "Permanent link")
...
## Open Internet[¶](https://fastapi.tiangolo.com/advanced/strict-content-type/#open-internet "Permanent link")
...
## Allowing Requests Without Content-Type[¶](https://fastapi.tiangolo.com/advanced/strict-content-type/#allowing-requests-without-content-type "Permanent link")
...
`from fastapi import FastAPI from pydantic import BaseModel app = FastAPI(strict_content_type=False) class Item(BaseModel):     name: str    price: float @app.post("/items/") async def create_item(item: Item):     return item`
