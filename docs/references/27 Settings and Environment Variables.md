...
[fast →](javascript:void\(0\))pip install pydantic-settings████████████████████████████████████████ 100%  
...
[fast →](javascript:void\(0\))pip install "fastapi\[all\]"████████████████████████████████████████ 100%  
[restart ↻](javascript:void\(0\))
...
[fast →](javascript:void\(0\))ADMIN\_EMAIL="deadpool@example.com" APP\_NAME="ChimichangApp" fastapi run main.py  
...
[Python 3.10+ - non-Annotated](#__tabbed_6_1)
...
[Python 3.10+ - non-Annotated](#__tabbed_8_1)
...
[Python 3.10+ - non-Annotated](#__tabbed_10_1)
...
[Python 3.10+ - non-Annotated](#__tabbed_12_1)
...
[Python 3.10+ - non-Annotated](#__tabbed_14_1)
...
### Creating the `Settings` only once with `lru_cache`[¶](https://fastapi.tiangolo.com/advanced/settings/#creating-the-settings-only-once-with-lru-cache "Permanent link")
...
[Python 3.10+ - non-Annotated](#__tabbed_16_1)
...
#### `lru_cache` Technical Details[¶](https://fastapi.tiangolo.com/advanced/settings/#lru-cache-technical-details "Permanent link")
