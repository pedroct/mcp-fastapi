...
## Proxy Forwarded Headers[¶](https://fastapi.tiangolo.com/advanced/behind-a-proxy/#proxy-forwarded-headers "Permanent link")
...
### Enable Proxy Forwarded Headers[¶](https://fastapi.tiangolo.com/advanced/behind-a-proxy/#enable-proxy-forwarded-headers "Permanent link")
...
[fast →](javascript:void\(0\))fastapi run --forwarded-allow-ips="\*"  
INFO:     Uvicorn running on http://127.0.0.1:8000 (Press CTRL+C to quit)  
  
[restart ↻](javascript:void\(0\))

### Redirects with HTTPS[¶](https://fastapi.tiangolo.com/advanced/behind-a-proxy/#redirects-with-https "Permanent link")
...
### How Proxy Forwarded Headers Work[¶](https://fastapi.tiangolo.com/advanced/behind-a-proxy/#how-proxy-forwarded-headers-work "Permanent link")
...
### Providing the `root_path`[¶](https://fastapi.tiangolo.com/advanced/behind-a-proxy/#providing-the-root-path "Permanent link")

To achieve this, you can use the command line option `--root-path` like:

`fastapi run main.py --forwarded-allow-ips="*" --root-path /api/v1`

[fast →](javascript:void\(0\))fastapi run main.py --forwarded-allow-ips="\*" --root-path /api/v1  
INFO:     Uvicorn running on http://127.0.0.1:8000 (Press CTRL+C to quit)  
...
### Checking the current `root_path`[¶](https://fastapi.tiangolo.com/advanced/behind-a-proxy/#checking-the-current-root-path "Permanent link")
...
### Setting the `root_path` in the FastAPI app[¶](https://fastapi.tiangolo.com/advanced/behind-a-proxy/#setting-the-root-path-in-the-fastapi-app "Permanent link")
...
### About `root_path`[¶](https://fastapi.tiangolo.com/advanced/behind-a-proxy/#about-root-path "Permanent link")
...
[fast →](javascript:void\(0\))./traefik --configFile=traefik.toml  
...
### Disable automatic server from `root_path`[¶](https://fastapi.tiangolo.com/advanced/behind-a-proxy/#disable-automatic-server-from-root-path "Permanent link")
